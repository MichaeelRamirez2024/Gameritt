    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg" style={{ maxWidth: "400px", width: "100%" }}>
                <h2 className="text-center text-2xl font-bold text-orange-600 mb-4">Sign-In</h2>
                <form onSubmit={handleLogin}>
                    ...
                    <button type="submit" className="w-full bg-orange-600 text-white font-semibold py-2 rounded-md hover:bg-orange-700 transition duration-200">Let's Sign</button>
                    <button type="submit" className="w-full bg-orange-600 text-white font-semibold py-2 rounded-md hover:bg-orange-700 transition duration-200 my-4"><Link to='/registro'>Make Account</Link></button>
